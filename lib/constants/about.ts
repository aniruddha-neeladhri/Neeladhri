...
export const ABOUT_LUXURY_LAST_SECTION = {
  ...
  cta: "Get started",
  ctaHref: "/contact",
  image: "/About/aboutlastsection.png",
...
export const ABOUT_LUXURY_HERO = {
  ...
  ctaHref: "/collection",
  image: "/About/aboutluxurymain.png",
