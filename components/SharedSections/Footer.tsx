      ...
      <div className="lg:hidden flex flex-col items-center text-center px-4 py-4 gap-y-5 bg-[#262626]">
        ...
        <div className="flex flex-col items-center gap-4 mt-6 w-full">
          <div className="flex gap-5 mb-2">
            ...
            <a href={SOCIAL.find(s => s.name === "Twitter")?.href || "#"} aria-label="Twitter" target="_blank" rel="noopener noreferrer" className="text-neutral-400 transition hover:text-white">
          ...
          <div className="grid grid-cols-1 gap-y-10 gap-x-10 text-left sm:grid-cols-2 lg:grid-cols-4 lg:gap-x-8">
            ...
            <div className="flex flex-col space-y-5">
              ...
              <div className="flex gap-5">
                ...
                <a href={SOCIAL.find(s => s.name === "Twitter")?.href || "#"} aria-label="Twitter" target="_blank" rel="noopener noreferrer" className="opacity-90 transition hover:opacity-100 text-white hover:text-neutral-300">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z"></path></svg>
                </a>
