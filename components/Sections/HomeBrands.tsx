...
/** Match title/desc to tallest in each row so headings share one line. */
function equalizeLuxuryCopy(root: HTMLElement | null) {
  if (!root) return;
...
export default function BrandsSection() {
  ...
  useLayoutEffect(() => {
    ...
    const run = () => equalizeLuxuryCopy(root);
    run();
              ...
              >
                ...
                <div className="relative aspect-[3/4] w-full">
                  ...
                  <div
                    ...
                    aria-hidden
                  />
                  <div className="absolute inset-x-0 bottom-0 z-10 flex flex-col justify-end gap-1 px-4 py-4 [text-shadow:0_1px_8px_rgba(0,0,0,0.85)]">
                    <p
                      data-brand-title
                      className="m-0 font-cormorant-garamond text-[20px] font-medium leading-tight sm:text-[22px] lg:text-[24px]"
                    ...
                    <p
                      data-brand-desc
                      className="m-0 font-cormorant-garamond text-[13px] font-light leading-snug sm:text-[14px] lg:text-[15px]"
                      style={{ color: bodyColor }}
                    >
                      {brand.description}
                    </p>
