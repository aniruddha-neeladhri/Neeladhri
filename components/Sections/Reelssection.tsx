...
const INSTAGRAM_URL = "https://www.instagram.com/neeladhriceramics?igsh=ajM2aXVqdWNqMnJp";
            ...
            >
              {reels.map((reel) => (
                <div
                  ...
                  className="relative shrink-0 snap-center md:snap-start w-full md:w-[230px] lg:w-[260px] xl:w-[280px] aspect-[9/16] overflow-hidden shadow-lg flex items-center justify-center cursor-pointer"
