        ...
        <div className="flex items-center gap-3 sm:gap-4 md:gap-5">
          {canScroll && (
            <button
              ...
              className={`flex shrink-0 items-center justify-center w-9 h-9 sm:w-10 sm:h-10 transition-all duration-200 select-none ${
                canPrev
            ...
            >
              {cards.map((card, index) => (
                <div
                  ...
                  className={`shrink-0 aspect-[1/1] xs:aspect-[5/6] sm:aspect-[2/3] md:aspect-[3/4] lg:aspect-[3/4] ${
                    index !== cards.length - 1 ? "pr-3 sm:pr-4 md:pr-5" : ""
                  }`}
                >
                  <Link
                    href={card.href}
